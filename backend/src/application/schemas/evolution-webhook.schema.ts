...
export type WebhookdeviceListMetadataSchemaType = z.infer<
  typeof DeviceListMetadataSchema
>;
...
export type WebhookMessageContextInfoSchemaType = z.infer<
  typeof MessageContextInfoSchema
>;
